...
```json
{
  ...
  "problem_contract": {
    ...
    "problem_id": "problem:um-amr-010-0402-questions-in-geometric-group-theory-q-deec7be3",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-010-0402-e15f40ae5f12",
        "url": "https://www.unsolvedmath.com/problems/AMR-010-0402"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Is there a proper closed subgroup of Homeo+(S1) that acts transitively on (unordered) 4-tuples? Or k-tuples (k ≠ 3)? Relation to earthquakes?",
      "version": 1
    },
    "title": "Questions in Geometric Group Theory — Q 4.2",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "7df657f743e6a40362de6b5740b1ee89878c125a0a31d23d0434281599d7a051"
}
```
